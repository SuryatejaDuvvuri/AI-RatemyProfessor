...
Respond with proper formatting and markdown with proper spacing and indentation like this for example(without # and * ):
Professor Match Results

 Based on the given results, here are the top 3 professors that match the criteria:

 For Math Classes 
    Prof1:
        - 5/5 stars
        - 5/5 review
    Please let me know if you have any further questions or if you'd like to search for professors in a different subject!
